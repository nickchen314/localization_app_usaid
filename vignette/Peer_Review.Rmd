...
Participants: Nicholas K Chen, Kento Horimai, Suyash Pasi, Murtaza Jawid
...
While the app has a solid foundation, including time-series analysis might improve knowledge of economic patterns over time. The inclusion of interactive components, such as sliders for altering statistical model parameters in real-time, might increase user engagement.
